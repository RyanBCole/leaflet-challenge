...
// retrieve & insert geoJSON data 1+ magnitude earthquakes
L.control
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/1.0_week.geojson").then(function (data) {
    ...
    function getColor(depth) {
        ...
        var depthThresholds = [10, 30, 50, 70, 90];
    ...
    // Update the getRadius function to adjust the size of the marker based on magnitude
